  ...
  <div class="list-container">
    <div class="sortList clearfix">
      ...
      <div class="right">
        ...
        <div class="news">
          <h4>
            <em class="fl">东篱园快讯</em>
            <span class="fr tip">更多 ></span>
          </h4>
          <div class="clearix"></div>
          <ul class="news-list unstyled">
            <li><span class="bold">[特惠]</span>备战618 全民八折购数码</li>
            <li><span class="bold">[公告]</span>6月新品上市 尝鲜特卖</li>
            <li><span class="bold">[特惠]</span>东篱园超市 限时促销</li>
            <li><span class="bold">[公告]</span>开心迎暑假 大牌等你来</li>
            <li><span class="bold">[特惠]</span>超值满减 敬请期待</li>
          </ul>
        </div>
