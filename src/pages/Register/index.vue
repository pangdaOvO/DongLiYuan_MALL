<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>用户名:</label>
        <input type="text" placeholder="请输入您的用户昵称" v-model="userName" name="name" >
         <!-- 表单验证失败：提示错误信息 -->
      </div>
      <div class="content">
        <label>手机号:</label>
    ...
    <div class="copyright">
      ...
      <div class="address">地址：四川轻化工大学（宜宾校区）</div>
      <div class="beian">京ICP备18104011109号
      </div>
    </div>
  </div>
</template>
